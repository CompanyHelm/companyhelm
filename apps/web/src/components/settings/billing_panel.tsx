            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-xs/relaxed text-muted-foreground">
                  Reserved for CompanyHelm-managed sessions.
                </p>
              </div>
              <div className="rounded-full bg-background p-2 text-primary shadow-sm ring-1 ring-primary/10">
            ...
            <div className="mt-4 grid gap-2 text-xs text-muted-foreground">
              <div className="flex items-center justify-between gap-3 rounded-lg border border-border/60 bg-background/80 px-3 py-2">
                ...
                <span className="text-right font-medium text-foreground">
                  {formatTimestamp(props.billing.nextRechargeAt)}
                </span>
              </div>
              {currentPlan ? (
                <div className="flex items-center justify-between gap-3 rounded-lg border border-border/60 bg-background/80 px-3 py-2">
                  ...
                  <span className="text-right font-medium text-foreground">
                    {UsageMetrics.formatUsdFromNano(currentPlan.monthlyCreditsNanoUsd)}
                  </span>
                </div>
              ) : null}
            </div>
          ...
          <div className="rounded-xl border border-border/70 bg-background/90 p-4 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-xs/relaxed text-muted-foreground">
                  Flexible credits outside the subscription wallet.
                </p>
              </div>
              <div className="rounded-full bg-muted p-2 text-muted-foreground ring-1 ring-border/60">
                <MailPlusIcon className="h-4 w-4" />
              </div>
            </div>
            <div className="mt-4 rounded-lg border border-border/60 bg-muted/35 px-3 py-2 text-xs/relaxed text-muted-foreground">
              To order pay-as-you-go credits, contact{" "}
              <a className="font-medium text-foreground underline-offset-4 hover:underline" href="mailto:support@companyhelm.com">
                support@companyhelm.com
              </a>
              .
            </div>
          </div>
