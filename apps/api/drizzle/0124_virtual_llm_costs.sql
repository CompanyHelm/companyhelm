...
ALTER TABLE "llm_usage_aggregates" ADD COLUMN "total_cost_nano_virtual_usd" bigint DEFAULT 0 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "session_turns" ADD COLUMN "usage_total_cost_nano_virtual_usd" bigint DEFAULT 0 NOT NULL;