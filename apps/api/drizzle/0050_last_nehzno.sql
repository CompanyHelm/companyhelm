ALTER TYPE "public"."compute_provider" ADD VALUE 'e2b';--> statement-breakpoint
...
CREATE TABLE "daytona_compute_provider_definitions" (
...
ALTER TABLE "daytona_compute_provider_definitions" ADD CONSTRAINT "daytona_compute_provider_definitions_compute_provider_definition_id_compute_provider_definitions_id_fk" FOREIGN KEY ("compute_provider_definition_id") REFERENCES "public"."compute_provider_definitions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "daytona_compute_provider_definitions_api_url_idx" ON "daytona_compute_provider_definitions" USING btree ("api_url");--> statement-breakpoint
