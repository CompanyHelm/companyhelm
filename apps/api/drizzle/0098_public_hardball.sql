...
ALTER TABLE "artifacts" ADD CONSTRAINT "artifacts_scope_target_check" CHECK (("artifacts"."scope_type" = 'company' AND "artifacts"."task_id" IS NULL AND "artifacts"."session_id" IS NULL) OR ("artifacts"."scope_type" = 'task' AND "artifacts"."task_id" IS NOT NULL AND "artifacts"."session_id" IS NULL) OR ("artifacts"."scope_type" = 'session' AND "artifacts"."task_id" IS NULL AND "artifacts"."session_id" IS NOT NULL));
