...
export const taskStages = pgTable("task_stages", {
  ...
  companyIdIndex: index("task_stages_company_id_idx").on(table.companyId),
...
export const tasks = pgTable("tasks", {
  ...
  companyTaskStageIdIndex: index("tasks_company_task_stage_id_idx").on(table.companyId, table.taskStageId),
