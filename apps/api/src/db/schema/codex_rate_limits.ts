...
export const codexRateLimitCredentialSourceEnum = pgEnum("codex_rate_limit_credential_source", [
  "platform",
  "user_provided",
]);
...
export const codexRateLimitSnapshots = pgTable("codex_rate_limit_snapshots", {
  ...
  credentialSource: codexRateLimitCredentialSourceEnum("credential_source").notNull(),
