...
/**
 * Owns the single company-scoped prompt override record. The OSS settings surface only persists
 * shared prompt context and leaves model credentials to company-provided provider records.
 */
@injectable()
